...
function Home() {
  return (
    ...
    <div id="myCarousel" className="carousel slide" data-ride="carousel" data-interval="8s">
      {/* Indicators */}
      ...
      <div className="carousel-inner">
        ...
        <div className="item">
          <img src=" https://www.itaerea.com/wp-content/uploads//air-transport-1.jpg" alt="Chicago" />
          <div className="carousel-caption">
        ...
        <div className="item">
          <img src="https://unctad.org/sites/default/files/2021-07/High-seas-1200x675.jpg" alt="New York" />
